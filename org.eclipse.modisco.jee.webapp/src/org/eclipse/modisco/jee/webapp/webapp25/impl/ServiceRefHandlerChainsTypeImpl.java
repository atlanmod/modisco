 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp25.impl.ServiceRefHandlerChainsTypeImpl#getHandlerChain <em>Handler Chain</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp25.impl.ServiceRefHandlerChainsTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceRefHandlerChainsTypeImpl extends EObjectImpl implements ServiceRefHandlerChainsType {
	...
	protected EClass eStaticClass() {
		return Webapp25Package.Literals.SERVICE_REF_HANDLER_CHAINS_TYPE;
	}
	...
	public EList<ServiceRefHandlerChainType> getHandlerChain() {
		if (handlerChain == null) {
			handlerChain = new EObjectContainmentEList<ServiceRefHandlerChainType>(ServiceRefHandlerChainType.class, this, Webapp25Package.SERVICE_REF_HANDLER_CHAINS_TYPE__HANDLER_CHAIN);
		}
		return handlerChain;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp25Package.SERVICE_REF_HANDLER_CHAINS_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Webapp25Package.SERVICE_REF_HANDLER_CHAINS_TYPE__HANDLER_CHAIN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Webapp25Package.SERVICE_REF_HANDLER_CHAINS_TYPE__ID:
				return getId();
		}
