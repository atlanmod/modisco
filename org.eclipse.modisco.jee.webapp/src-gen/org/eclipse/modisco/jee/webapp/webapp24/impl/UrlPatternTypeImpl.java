 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp24.impl.UrlPatternTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UrlPatternTypeImpl extends EObjectImpl implements UrlPatternType {
	...
	protected EClass eStaticClass() {
		return Webapp24Package.Literals.URL_PATTERN_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp24Package.URL_PATTERN_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Webapp24Package.URL_PATTERN_TYPE__VALUE:
				return getValue();
		}
