 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp24.impl.JspConfigTypeImpl#getTaglib <em>Taglib</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp24.impl.JspConfigTypeImpl#getJspPropertyGroup <em>Jsp Property Group</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp24.impl.JspConfigTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JspConfigTypeImpl extends EObjectImpl implements JspConfigType {
	...
	protected EClass eStaticClass() {
		return Webapp24Package.Literals.JSP_CONFIG_TYPE;
	}
	...
	public EList<TaglibType> getTaglib() {
		if (taglib == null) {
			taglib = new EObjectContainmentEList<TaglibType>(TaglibType.class, this, Webapp24Package.JSP_CONFIG_TYPE__TAGLIB);
		}
		return taglib;
	}
	...
	public EList<JspPropertyGroupType> getJspPropertyGroup() {
		if (jspPropertyGroup == null) {
			jspPropertyGroup = new EObjectContainmentEList<JspPropertyGroupType>(JspPropertyGroupType.class, this, Webapp24Package.JSP_CONFIG_TYPE__JSP_PROPERTY_GROUP);
		}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp24Package.JSP_CONFIG_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Webapp24Package.JSP_CONFIG_TYPE__TAGLIB:
				return ((InternalEList<?>)getTaglib()).basicRemove(otherEnd, msgs);
			case Webapp24Package.JSP_CONFIG_TYPE__JSP_PROPERTY_GROUP:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Webapp24Package.JSP_CONFIG_TYPE__ID:
				return getId();
		}
