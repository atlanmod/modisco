 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp23.impl.ListenerTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ListenerTypeImpl extends ListenerClassImpl implements ListenerType {
	...
	protected EClass eStaticClass() {
		return Webapp23Package.Literals.LISTENER_TYPE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp23Package.LISTENER_TYPE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Webapp23Package.LISTENER_TYPE__ID:
				return getId();
		}
