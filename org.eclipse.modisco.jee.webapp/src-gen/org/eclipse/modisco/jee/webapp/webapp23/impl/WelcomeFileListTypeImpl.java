...
public class WelcomeFileListTypeImpl extends EObjectImpl implements WelcomeFileListType {
	...
	protected EClass eStaticClass() {
		return Webapp23Package.Literals.WELCOME_FILE_LIST_TYPE;
	}
	...
	public EList<WelcomeFileType> getWelcomeFile() {
		if (welcomeFile == null) {
			welcomeFile = new EObjectContainmentEList<WelcomeFileType>(WelcomeFileType.class, this, Webapp23Package.WELCOME_FILE_LIST_TYPE__WELCOME_FILE);
		}
		return welcomeFile;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp23Package.WELCOME_FILE_LIST_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Webapp23Package.WELCOME_FILE_LIST_TYPE__WELCOME_FILE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Webapp23Package.WELCOME_FILE_LIST_TYPE__ID:
				return getId();
		}
