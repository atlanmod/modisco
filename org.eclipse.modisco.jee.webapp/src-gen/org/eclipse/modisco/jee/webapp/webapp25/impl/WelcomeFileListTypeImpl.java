 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp25.impl.WelcomeFileListTypeImpl#getWelcomeFile <em>Welcome File</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp25.impl.WelcomeFileListTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WelcomeFileListTypeImpl extends EObjectImpl implements WelcomeFileListType {
	...
	protected EClass eStaticClass() {
		return Webapp25Package.Literals.WELCOME_FILE_LIST_TYPE;
	}
	...
	public EList<String> getWelcomeFile() {
		if (welcomeFile == null) {
			welcomeFile = new EDataTypeEList<String>(String.class, this, Webapp25Package.WELCOME_FILE_LIST_TYPE__WELCOME_FILE);
		}
		return welcomeFile;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp25Package.WELCOME_FILE_LIST_TYPE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Webapp25Package.WELCOME_FILE_LIST_TYPE__WELCOME_FILE:
				return getWelcomeFile();
			case Webapp25Package.WELCOME_FILE_LIST_TYPE__ID:
				return getId();
		}
