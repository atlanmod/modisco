 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp25.impl.EmptyTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EmptyTypeImpl extends EObjectImpl implements EmptyType {
	...
	protected EClass eStaticClass() {
		return Webapp25Package.Literals.EMPTY_TYPE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp25Package.EMPTY_TYPE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Webapp25Package.EMPTY_TYPE__ID:
				return getId();
		}
