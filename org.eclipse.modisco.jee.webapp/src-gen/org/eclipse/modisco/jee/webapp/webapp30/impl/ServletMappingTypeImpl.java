 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp30.impl.ServletMappingTypeImpl#getServletName <em>Servlet Name</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp30.impl.ServletMappingTypeImpl#getUrlPattern <em>Url Pattern</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp30.impl.ServletMappingTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServletMappingTypeImpl extends EObjectImpl implements ServletMappingType {
	...
	protected EClass eStaticClass() {
		return Webapp30Package.eINSTANCE.getServletMappingType();
	}
	...
	public NotificationChain basicSetServletName(ServletNameType newServletName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp30Package.SERVLET_MAPPING_TYPE__SERVLET_NAME, oldServletName, newServletName);
	...
	public void setServletName(ServletNameType newServletName) {
		if (newServletName != servletName) {
			...
			if (servletName != null)
				msgs = ((InternalEObject)servletName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.SERVLET_MAPPING_TYPE__SERVLET_NAME, null, msgs);
			if (newServletName != null)
				msgs = ((InternalEObject)newServletName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.SERVLET_MAPPING_TYPE__SERVLET_NAME, null, msgs);
			msgs = basicSetServletName(newServletName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.SERVLET_MAPPING_TYPE__SERVLET_NAME, newServletName, newServletName));
	}
	...
	public EList<UrlPatternType> getUrlPattern() {
		if (urlPattern == null) {
			urlPattern = new EObjectContainmentEList<UrlPatternType>(UrlPatternType.class, this, Webapp30Package.SERVLET_MAPPING_TYPE__URL_PATTERN);
		}
		return urlPattern;
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.SERVLET_MAPPING_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Webapp30Package.SERVLET_MAPPING_TYPE__SERVLET_NAME:
				return basicSetServletName(null, msgs);
			case Webapp30Package.SERVLET_MAPPING_TYPE__URL_PATTERN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Webapp30Package.SERVLET_MAPPING_TYPE__ID:
				return getId();
		}
