...
public class RespectBindingTypeImpl extends EObjectImpl implements RespectBindingType {
	...
	protected EClass eStaticClass() {
		return Webapp30Package.eINSTANCE.getRespectBindingType();
	}
	...
	public NotificationChain basicSetEnabled(TrueFalseType newEnabled, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp30Package.RESPECT_BINDING_TYPE__ENABLED, oldEnabled, newEnabled);
	...
	public void setEnabled(TrueFalseType newEnabled) {
		if (newEnabled != enabled) {
			...
			if (enabled != null)
				msgs = ((InternalEObject)enabled).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.RESPECT_BINDING_TYPE__ENABLED, null, msgs);
			if (newEnabled != null)
				msgs = ((InternalEObject)newEnabled).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.RESPECT_BINDING_TYPE__ENABLED, null, msgs);
			msgs = basicSetEnabled(newEnabled, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.RESPECT_BINDING_TYPE__ENABLED, newEnabled, newEnabled));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Webapp30Package.RESPECT_BINDING_TYPE__ENABLED:
