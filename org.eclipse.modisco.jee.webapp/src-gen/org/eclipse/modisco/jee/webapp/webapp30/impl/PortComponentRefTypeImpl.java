 ...
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp30.impl.PortComponentRefTypeImpl#getMtomThreshold <em>Mtom Threshold</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp30.impl.PortComponentRefTypeImpl#getAddressing <em>Addressing</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp30.impl.PortComponentRefTypeImpl#getRespectBinding <em>Respect Binding</em>}</li>
...
public class PortComponentRefTypeImpl extends EObjectImpl implements PortComponentRefType {
	 ...
	 * @ordered
	 */
	protected org.eclipse.modisco.jee.webapp.webapp30.String portComponentLink;
	...
	protected EClass eStaticClass() {
		return Webapp30Package.eINSTANCE.getPortComponentRefType();
	}
	...
	public NotificationChain basicSetServiceEndpointInterface(FullyQualifiedClassType newServiceEndpointInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__SERVICE_ENDPOINT_INTERFACE, oldServiceEndpointInterface, newServiceEndpointInterface);
	...
	public void setServiceEndpointInterface(FullyQualifiedClassType newServiceEndpointInterface) {
		if (newServiceEndpointInterface != serviceEndpointInterface) {
			...
			if (serviceEndpointInterface != null)
				msgs = ((InternalEObject)serviceEndpointInterface).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__SERVICE_ENDPOINT_INTERFACE, null, msgs);
			if (newServiceEndpointInterface != null)
				msgs = ((InternalEObject)newServiceEndpointInterface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__SERVICE_ENDPOINT_INTERFACE, null, msgs);
			msgs = basicSetServiceEndpointInterface(newServiceEndpointInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__SERVICE_ENDPOINT_INTERFACE, newServiceEndpointInterface, newServiceEndpointInterface));
	}
	...
	public NotificationChain basicSetEnableMtom(TrueFalseType newEnableMtom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__ENABLE_MTOM, oldEnableMtom, newEnableMtom);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEnableMtom(TrueFalseType newEnableMtom) {
		if (newEnableMtom != enableMtom) {
			NotificationChain msgs = null;
			if (enableMtom != null)
				msgs = ((InternalEObject)enableMtom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__ENABLE_MTOM, null, msgs);
			if (newEnableMtom != null)
				msgs = ((InternalEObject)newEnableMtom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__ENABLE_MTOM, null, msgs);
			msgs = basicSetEnableMtom(newEnableMtom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__ENABLE_MTOM, newEnableMtom, newEnableMtom));
	}
	...
	public NotificationChain basicSetMtomThreshold(XsdNonNegativeIntegerType newMtomThreshold, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__MTOM_THRESHOLD, oldMtomThreshold, newMtomThreshold);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMtomThreshold(XsdNonNegativeIntegerType newMtomThreshold) {
		if (newMtomThreshold != mtomThreshold) {
			...
			if (mtomThreshold != null)
				msgs = ((InternalEObject)mtomThreshold).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__MTOM_THRESHOLD, null, msgs);
			if (newMtomThreshold != null)
				msgs = ((InternalEObject)newMtomThreshold).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__MTOM_THRESHOLD, null, msgs);
			msgs = basicSetMtomThreshold(newMtomThreshold, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__MTOM_THRESHOLD, newMtomThreshold, newMtomThreshold));
	}
	...
	public NotificationChain basicSetAddressing(AddressingType newAddressing, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__ADDRESSING, oldAddressing, newAddressing);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAddressing(AddressingType newAddressing) {
		if (newAddressing != addressing) {
			NotificationChain msgs = null;
			if (addressing != null)
				msgs = ((InternalEObject)addressing).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__ADDRESSING, null, msgs);
			if (newAddressing != null)
				msgs = ((InternalEObject)newAddressing).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__ADDRESSING, null, msgs);
			msgs = basicSetAddressing(newAddressing, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__ADDRESSING, newAddressing, newAddressing));
	}
	...
	public NotificationChain basicSetRespectBinding(RespectBindingType newRespectBinding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__RESPECT_BINDING, oldRespectBinding, newRespectBinding);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRespectBinding(RespectBindingType newRespectBinding) {
		if (newRespectBinding != respectBinding) {
			...
			if (respectBinding != null)
				msgs = ((InternalEObject)respectBinding).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__RESPECT_BINDING, null, msgs);
			if (newRespectBinding != null)
				msgs = ((InternalEObject)newRespectBinding).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__RESPECT_BINDING, null, msgs);
			msgs = basicSetRespectBinding(newRespectBinding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__RESPECT_BINDING, newRespectBinding, newRespectBinding));
	}
	 ...
	 * @generated
	 */
	public org.eclipse.modisco.jee.webapp.webapp30.String getPortComponentLink() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPortComponentLink(org.eclipse.modisco.jee.webapp.webapp30.String newPortComponentLink, NotificationChain msgs) {
		org.eclipse.modisco.jee.webapp.webapp30.String oldPortComponentLink = portComponentLink;
		portComponentLink = newPortComponentLink;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__PORT_COMPONENT_LINK, oldPortComponentLink, newPortComponentLink);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setPortComponentLink(org.eclipse.modisco.jee.webapp.webapp30.String newPortComponentLink) {
		if (newPortComponentLink != portComponentLink) {
			NotificationChain msgs = null;
			if (portComponentLink != null)
				msgs = ((InternalEObject)portComponentLink).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__PORT_COMPONENT_LINK, null, msgs);
			if (newPortComponentLink != null)
				msgs = ((InternalEObject)newPortComponentLink).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp30Package.PORT_COMPONENT_REF_TYPE__PORT_COMPONENT_LINK, null, msgs);
			msgs = basicSetPortComponentLink(newPortComponentLink, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__PORT_COMPONENT_LINK, newPortComponentLink, newPortComponentLink));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.PORT_COMPONENT_REF_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__SERVICE_ENDPOINT_INTERFACE:
				return basicSetServiceEndpointInterface(null, msgs);
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__ENABLE_MTOM:
				return basicSetEnableMtom(null, msgs);
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__MTOM_THRESHOLD:
				return basicSetMtomThreshold(null, msgs);
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__ADDRESSING:
				return basicSetAddressing(null, msgs);
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__RESPECT_BINDING:
				return basicSetRespectBinding(null, msgs);
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__PORT_COMPONENT_LINK:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__ID:
				return getId();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__RESPECT_BINDING:
				...
				return;
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__PORT_COMPONENT_LINK:
				setPortComponentLink((org.eclipse.modisco.jee.webapp.webapp30.String)newValue);
				return;
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__ID:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__RESPECT_BINDING:
				...
				return;
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__PORT_COMPONENT_LINK:
				setPortComponentLink((org.eclipse.modisco.jee.webapp.webapp30.String)null);
				return;
			case Webapp30Package.PORT_COMPONENT_REF_TYPE__ID:
				setId(ID_EDEFAULT);
				return;
