 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp30.impl.OrderingOthersTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderingOthersTypeImpl extends EObjectImpl implements OrderingOthersType {
	...
	protected EClass eStaticClass() {
		return Webapp30Package.eINSTANCE.getOrderingOthersType();
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.ORDERING_OTHERS_TYPE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Webapp30Package.ORDERING_OTHERS_TYPE__ID:
				return getId();
		}
