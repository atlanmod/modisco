...
public class LocaleEncodingMappingTypeImpl extends EObjectImpl implements LocaleEncodingMappingType {
	...
	protected EClass eStaticClass() {
		return Webapp30Package.eINSTANCE.getLocaleEncodingMappingType();
	}
	...
	public void setLocale(String newLocale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.LOCALE_ENCODING_MAPPING_TYPE__LOCALE, oldLocale, locale));
	}
	...
	public void setEncoding(String newEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.LOCALE_ENCODING_MAPPING_TYPE__ENCODING, oldEncoding, encoding));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp30Package.LOCALE_ENCODING_MAPPING_TYPE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Webapp30Package.LOCALE_ENCODING_MAPPING_TYPE__LOCALE:
				return getLocale();
			case Webapp30Package.LOCALE_ENCODING_MAPPING_TYPE__ENCODING:
				return getEncoding();
			case Webapp30Package.LOCALE_ENCODING_MAPPING_TYPE__ID:
				return getId();
		}
