...
public final class Messages extends NLS {
	...
	public static String CustomizationEditor_customizationConverted;
	public static String CustomizationEditor_customizationConvertedLong;
	...
	public static String CustomizationEditor_problemsInFile;
	...
	public static String CustomizationViewer_metaclassIcon;
	public static String CustomizationViewer_metaclassVisible;
	public static String CustomizationViewer_stickerIcon;
