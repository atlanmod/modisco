...
public class GenerateJava extends AbstractAcceleoGenerator {
    ...
    resourceSet.getPackageRegistry().put(org.eclipse.gmt.modisco.java.emf.JavaPackage.eINSTANCE.getNsURI(), org.eclipse.gmt.modisco.java.emf.JavaPackage.eINSTANCE);
