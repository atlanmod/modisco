 ...
 * @generated
 */
public class SerieItemProvider
	 ...
	 * @generated
	 */
	public SerieItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Serie"));
	}
	...
	public String getText(Object object) {
		String label = ((Serie)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Serie_type") :
			getString("_UI_Serie_type") + " " + label;
	}
