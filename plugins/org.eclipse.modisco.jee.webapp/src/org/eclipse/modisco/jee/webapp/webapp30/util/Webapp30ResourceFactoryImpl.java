 ...
 * @see org.eclipse.modisco.jee.webapp.webapp30.util.Webapp30ResourceImpl
 * @generated
 */
public class Webapp30ResourceFactoryImpl extends ResourceFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public Webapp30ResourceFactoryImpl() {
		super();
	}
	...
	public Resource createResource(final URI uri) {
		XMLResource result = new Webapp30ResourceImpl(uri);
	...
	class MoDiscoURIHandler implements URIHandler {
		...
		private final URI jeeStandardURI = URI
				.createURI("http://java.sun.com/xml/ns/javaee/web-app_3_0.xsd");

		private final URI modiscoSubstituteURI = URI
				.createURI("http://www.eclipse.org/MoDisco/Javaee/web-app_3_0.xsd");
