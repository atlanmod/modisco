 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp22.impl.TaglibTypeImpl#getTaglibUri <em>Taglib Uri</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp22.impl.TaglibTypeImpl#getTaglibLocation <em>Taglib Location</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.webapp.webapp22.impl.TaglibTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaglibTypeImpl extends EObjectImpl implements TaglibType {
	...
	protected EClass eStaticClass() {
		return Webapp22Package.Literals.TAGLIB_TYPE;
	}
	...
	public NotificationChain basicSetTaglibUri(TaglibUriType newTaglibUri, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp22Package.TAGLIB_TYPE__TAGLIB_URI, oldTaglibUri, newTaglibUri);
	...
	public void setTaglibUri(TaglibUriType newTaglibUri) {
		if (newTaglibUri != taglibUri) {
			...
			if (taglibUri != null)
				msgs = ((InternalEObject)taglibUri).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp22Package.TAGLIB_TYPE__TAGLIB_URI, null, msgs);
			if (newTaglibUri != null)
				msgs = ((InternalEObject)newTaglibUri).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp22Package.TAGLIB_TYPE__TAGLIB_URI, null, msgs);
			msgs = basicSetTaglibUri(newTaglibUri, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp22Package.TAGLIB_TYPE__TAGLIB_URI, newTaglibUri, newTaglibUri));
	}
	...
	public NotificationChain basicSetTaglibLocation(TaglibLocationType newTaglibLocation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Webapp22Package.TAGLIB_TYPE__TAGLIB_LOCATION, oldTaglibLocation, newTaglibLocation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTaglibLocation(TaglibLocationType newTaglibLocation) {
		if (newTaglibLocation != taglibLocation) {
			...
			if (taglibLocation != null)
				msgs = ((InternalEObject)taglibLocation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Webapp22Package.TAGLIB_TYPE__TAGLIB_LOCATION, null, msgs);
			if (newTaglibLocation != null)
				msgs = ((InternalEObject)newTaglibLocation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Webapp22Package.TAGLIB_TYPE__TAGLIB_LOCATION, null, msgs);
			msgs = basicSetTaglibLocation(newTaglibLocation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp22Package.TAGLIB_TYPE__TAGLIB_LOCATION, newTaglibLocation, newTaglibLocation));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Webapp22Package.TAGLIB_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Webapp22Package.TAGLIB_TYPE__TAGLIB_URI:
				return basicSetTaglibUri(null, msgs);
			case Webapp22Package.TAGLIB_TYPE__TAGLIB_LOCATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Webapp22Package.TAGLIB_TYPE__ID:
				return getId();
		}
