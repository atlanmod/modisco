 ...
 * @generated
 */
public class Webapp23PackageImpl extends EPackageImpl implements Webapp23Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass filterClassTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass listenerClassEClass = null;
	 ...
	 * @generated
	 */
	private EClass listenerClassTypeEClass = null;
	 ...
	 * @see org.eclipse.modisco.jee.webapp.webapp23.Webapp23Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Webapp23PackageImpl() {
		super(eNS_URI, Webapp23Factory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static Webapp23Package init() {
		...
		theWebapp23Package.createPackageContents();

		// Initialize created meta-data
		theWebapp23Package.initializePackageContents();
	 ...
	 * @generated
	 */
	public EReference getDocumentRoot_FilterClass() {
	 ...
	 * @generated
	 */
	public EReference getDocumentRoot_FilterMapping() {
	 ...
	 * @generated
	 */
	public EReference getDocumentRoot_FilterName() {
	 ...
	 * @generated
	 */
	public EClass getFilterClassType() {
		return filterClassTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getFilterClassType_Mixed() {
		return (EAttribute)filterClassTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFilterClassType_Id() {
		return (EAttribute)filterClassTypeEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getFilterMappingType_UrlPattern() {
		return (EReference)filterMappingTypeEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getFilterMappingType_Id() {
		return (EAttribute)filterMappingTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFilterNameType_Mixed() {
		return (EAttribute)filterNameTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFilterNameType_Id() {
		return (EAttribute)filterNameTypeEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getListenerClass_ListenerClass() {
		return (EReference)listenerClassEClass.getEStructuralFeatures().get(0);
	}
	...
	public EClass getListenerClassType() {
		return listenerClassTypeEClass;
	}
	...
	public EAttribute getListenerClassType_Mixed() {
		return (EAttribute)listenerClassTypeEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getListenerClassType_Id() {
		return (EAttribute)listenerClassTypeEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getWebAppType_Id() {
		return (EAttribute)webAppTypeEClass.getEStructuralFeatures().get(23);
	}
	 ...
	 * @generated
	 */
	public Webapp23Factory getWebapp23Factory() {
		return (Webapp23Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(documentRootEClass, DOCUMENT_ROOT__FILTER_CLASS);
		createEReference(documentRootEClass, DOCUMENT_ROOT__FILTER_MAPPING);
		createEReference(documentRootEClass, DOCUMENT_ROOT__FILTER_NAME);
		...
		createEReference(documentRootEClass, DOCUMENT_ROOT__LISTENER_CLASS);
		...
		filterClassTypeEClass = createEClass(FILTER_CLASS_TYPE);
		createEAttribute(filterClassTypeEClass, FILTER_CLASS_TYPE__MIXED);
		createEAttribute(filterClassTypeEClass, FILTER_CLASS_TYPE__ID);
		...
		createEAttribute(filterNameTypeEClass, FILTER_NAME_TYPE__MIXED);
		createEAttribute(filterNameTypeEClass, FILTER_NAME_TYPE__ID);
		...
		listenerClassEClass = createEClass(LISTENER_CLASS);
		createEReference(listenerClassEClass, LISTENER_CLASS__LISTENER_CLASS);

		listenerClassTypeEClass = createEClass(LISTENER_CLASS_TYPE);
		createEAttribute(listenerClassTypeEClass, LISTENER_CLASS_TYPE__MIXED);
		createEAttribute(listenerClassTypeEClass, LISTENER_CLASS_TYPE__ID);
	...
	public void initializePackageContents() {
		...
		listenerTypeEClass.getESuperTypes().add(this.getListenerClass());
		...
		initEReference(getDocumentRoot_Filter(), this.getFilterType(), null, "filter", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getDocumentRoot_FilterClass(), this.getFilterClassType(), null, "filterClass", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getDocumentRoot_FilterMapping(), this.getFilterMappingType(), null, "filterMapping", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getDocumentRoot_FilterName(), this.getFilterNameType(), null, "filterName", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getDocumentRoot_Listener(), this.getListenerType(), null, "listener", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getDocumentRoot_ListenerClass(), this.getListenerClassType(), null, "listenerClass", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEClass(filterClassTypeEClass, FilterClassType.class, "FilterClassType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getFilterClassType_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, FilterClassType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getFilterClassType_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, FilterClassType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getFilterNameType_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, FilterNameType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getFilterNameType_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, FilterNameType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getFilterType_FilterClass(), this.getFilterClassType(), null, "filterClass", null, 1, 1, FilterType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getFilterType_InitParam(), this.getInitParamType(), null, "initParam", null, 0, -1, FilterType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEClass(listenerClassEClass, ListenerClass.class, "ListenerClass", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getListenerClass_ListenerClass(), this.getListenerClassType(), null, "listenerClass", null, 1, 1, ListenerClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(listenerClassTypeEClass, ListenerClassType.class, "ListenerClassType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getListenerClassType_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, ListenerClassType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getListenerClassType_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, ListenerClassType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
