...
public class HtmlReport2 extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public HtmlReport2(URI modelURI, File targetFolder, List<? extends Object> arguments)
			throws IOException {
	 ...
	 * @generated
	 */
	public HtmlReport2(EObject model, File targetFolder, List<? extends Object> arguments)
			throws IOException {
	...
	public static void main(final String[] args) {
		try {
			...
			if (args.length < 2) {
				...
				HtmlReport2 generator = new HtmlReport2(modelURI, folder, arguments);

				/*
				 * Add the properties from the launch arguments. If you want to
				 * programmatically add new arguments, add them in
				 ...
				 * in order to return a new property loader. The basic
				 * properties loader will look for properties in the current
				 * project if the path of the properties file is like this
				 * "packagea.packageb.packagec.default" for a properties file
				 * named default.properties, or if the path is an absolute path.
	...
	public void doGenerate(final Monitor monitor) throws IOException {
		...
		try {
			BirtGraphHelper.createBirtGraph((AveragedMultiDiscoveryBenchmark) getModel(), getTargetFolder());
		} catch (ChartException e) {
			MoDiscoLogger.logError(e, "Error generating Birt graph", Activator.getDefault()); //$NON-NLS-1$
		}
