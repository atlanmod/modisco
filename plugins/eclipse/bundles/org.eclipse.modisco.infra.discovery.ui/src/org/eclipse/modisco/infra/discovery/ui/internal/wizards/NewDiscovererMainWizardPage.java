...
public class NewDiscovererMainWizardPage extends NewTypeWizardPage {
	...
	protected void createTypeMembers(final IType type, final ImportsManager imports,
		...
		// @Override
		// public void basicDiscoverElement(final IFile source, final
		...
		buf.append("public void basicDiscoverElement(final ").append(inputType).append(" source, final ").append(progressMonitor).append(" monitor) throws ").append(discoveryException).append(" {").append(lineDelimiter); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
