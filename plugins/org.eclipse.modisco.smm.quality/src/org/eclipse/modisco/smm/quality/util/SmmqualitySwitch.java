 ...
 * @generated
 */
public class SmmqualitySwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SmmqualityPackage.QUALITY_SCOPE: {
				QualityScope qualityScope = (QualityScope)theEObject;
				T result = caseQualityScope(qualityScope);
				if (result == null) result = caseScope(qualityScope);
				if (result == null) result = caseAbstractMeasureElement(qualityScope);
				if (result == null) result = caseSmmElement(qualityScope);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SmmqualityPackage.MEASURAND: {
				Measurand measurand = (Measurand)theEObject;
				T result = caseMeasurand(measurand);
				if (result == null) result = caseAbstractMeasureElement(measurand);
				if (result == null) result = caseSmmElement(measurand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Quality Scope</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Quality Scope</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQualityScope(QualityScope object) {
		return null;
	}
