 ...
 * <ul>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.ClassDeclarationImpl#getSuperClass
...
public class ClassDeclarationImpl extends TypeDeclarationImpl implements
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSuperClass(TypeAccess newSuperClass,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					JavaPackage.CLASS_DECLARATION__SUPER_CLASS, oldSuperClass,
					newSuperClass);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSuperClass(TypeAccess newSuperClass) {
		if (newSuperClass != superClass) {
			...
			if (superClass != null)
				msgs = ((InternalEObject) superClass).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- JavaPackage.CLASS_DECLARATION__SUPER_CLASS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JavaPackage.CLASS_DECLARATION__SUPER_CLASS, newSuperClass,
					newSuperClass));
	}
