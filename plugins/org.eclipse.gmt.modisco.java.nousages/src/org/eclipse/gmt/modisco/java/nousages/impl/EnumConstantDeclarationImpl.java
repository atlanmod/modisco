 ...
 * <ul>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.EnumConstantDeclarationImpl#getExtraArrayDimensions
 * <em>Extra Array Dimensions</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.EnumConstantDeclarationImpl#getInitializer
 * <em>Initializer</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.EnumConstantDeclarationImpl#getAnonymousClassDeclaration
 * <em>Anonymous Class Declaration</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.EnumConstantDeclarationImpl#getArguments
 * <em>Arguments</em>}</li>
 * </ul>
 * </p>
 * 
...
public class EnumConstantDeclarationImpl extends BodyDeclarationImpl implements
	...
	/**
	 * The cached value of the '{@link #getInitializer() <em>Initializer</em>}'
	...
	/**
	 * The cached value of the '{@link #getAnonymousClassDeclaration()
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInitializer(Expression newInitializer,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					JavaPackage.ENUM_CONSTANT_DECLARATION__INITIALIZER,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAnonymousClassDeclaration(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					JavaPackage.ENUM_CONSTANT_DECLARATION__ANONYMOUS_CLASS_DECLARATION,
					oldAnonymousClassDeclaration, newAnonymousClassDeclaration);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setAnonymousClassDeclaration(
		...
		if (newAnonymousClassDeclaration != anonymousClassDeclaration) {
			...
			if (anonymousClassDeclaration != null)
				msgs = ((InternalEObject) anonymousClassDeclaration)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- JavaPackage.ENUM_CONSTANT_DECLARATION__ANONYMOUS_CLASS_DECLARATION,
			...
			if (newAnonymousClassDeclaration != null)
				msgs = ((InternalEObject) newAnonymousClassDeclaration)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- JavaPackage.ENUM_CONSTANT_DECLARATION__ANONYMOUS_CLASS_DECLARATION,
								null, msgs);
			msgs = basicSetAnonymousClassDeclaration(
					newAnonymousClassDeclaration, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					JavaPackage.ENUM_CONSTANT_DECLARATION__ANONYMOUS_CLASS_DECLARATION,
					newAnonymousClassDeclaration, newAnonymousClassDeclaration));
	}
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Expression>(
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == VariableDeclaration.class) {
			...
			case JavaPackage.ENUM_CONSTANT_DECLARATION__EXTRA_ARRAY_DIMENSIONS:
				return JavaPackage.VARIABLE_DECLARATION__EXTRA_ARRAY_DIMENSIONS;
			case JavaPackage.ENUM_CONSTANT_DECLARATION__INITIALIZER:
				return JavaPackage.VARIABLE_DECLARATION__INITIALIZER;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == VariableDeclaration.class) {
			...
			case JavaPackage.VARIABLE_DECLARATION__EXTRA_ARRAY_DIMENSIONS:
				return JavaPackage.ENUM_CONSTANT_DECLARATION__EXTRA_ARRAY_DIMENSIONS;
			case JavaPackage.VARIABLE_DECLARATION__INITIALIZER:
				return JavaPackage.ENUM_CONSTANT_DECLARATION__INITIALIZER;
			default:
				return -1;
			}
		}
