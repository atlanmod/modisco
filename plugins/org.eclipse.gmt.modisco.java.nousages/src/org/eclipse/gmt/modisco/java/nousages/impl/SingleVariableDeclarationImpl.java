 ...
 * <ul>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.SingleVariableDeclarationImpl#getModifier
 * <em>Modifier</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.SingleVariableDeclarationImpl#isVarargs
 * <em>Varargs</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.SingleVariableDeclarationImpl#getType
 * <em>Type</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.SingleVariableDeclarationImpl#getAnnotations
 * <em>Annotations</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.SingleVariableDeclarationImpl#getMethodDeclaration
 * <em>Method Declaration</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.SingleVariableDeclarationImpl#getCatchClause
 * <em>Catch Clause</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.SingleVariableDeclarationImpl#getEnhancedForStatement
 * <em>Enhanced For Statement</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class SingleVariableDeclarationImpl extends VariableDeclarationImpl
		implements SingleVariableDeclaration {
	/**
	 * The cached value of the '{@link #getModifier() <em>Modifier</em>}'
	...
	/**
	 * The default value of the '{@link #isVarargs() <em>Varargs</em>}'
	...
	/**
	 * The cached value of the '{@link #isVarargs() <em>Varargs</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isVarargs()
	 * @generated
	 ...
	 * @generated
	 */
	public NotificationChain basicSetModifier(Modifier newModifier,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					JavaPackage.SINGLE_VARIABLE_DECLARATION__MODIFIER,
		...
		if (newModifier != modifier) {
			...
			if (modifier != null)
				msgs = ((InternalEObject) modifier).eInverseRemove(this,
						JavaPackage.MODIFIER__SINGLE_VARIABLE_DECLARATION,
						Modifier.class, msgs);
			if (newModifier != null)
	...
	public NotificationChain basicSetType(TypeAccess newType,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					JavaPackage.SINGLE_VARIABLE_DECLARATION__TYPE, oldType,
					newType);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setType(TypeAccess newType) {
		if (newType != type) {
				...
				msgs = ((InternalEObject) type)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- JavaPackage.SINGLE_VARIABLE_DECLARATION__TYPE,
								null, msgs);
			if (newType != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JavaPackage.SINGLE_VARIABLE_DECLARATION__TYPE, newType,
					newType));
	}
	...
	public EList<Annotation> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<Annotation>(
					...
					JavaPackage.SINGLE_VARIABLE_DECLARATION__ANNOTATIONS);
		}
		return annotations;
	}
	...
	public AbstractMethodDeclaration getMethodDeclaration() {
		if (eContainerFeatureID() != JavaPackage.SINGLE_VARIABLE_DECLARATION__METHOD_DECLARATION)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMethodDeclaration(
	...
	public void setMethodDeclaration(
		...
		if (newMethodDeclaration != eInternalContainer()
				|| (eContainerFeatureID() != JavaPackage.SINGLE_VARIABLE_DECLARATION__METHOD_DECLARATION && newMethodDeclaration != null)) {
			...
			if (newMethodDeclaration != null)
				msgs = ((InternalEObject) newMethodDeclaration).eInverseAdd(
						this,
						JavaPackage.ABSTRACT_METHOD_DECLARATION__PARAMETERS,
						AbstractMethodDeclaration.class, msgs);
	...
	public CatchClause getCatchClause() {
		if (eContainerFeatureID() != JavaPackage.SINGLE_VARIABLE_DECLARATION__CATCH_CLAUSE)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCatchClause(CatchClause newCatchClause,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newCatchClause,
				JavaPackage.SINGLE_VARIABLE_DECLARATION__CATCH_CLAUSE, msgs);
		return msgs;
	}
	...
	public void setCatchClause(CatchClause newCatchClause) {
		if (newCatchClause != eInternalContainer()
				|| (eContainerFeatureID() != JavaPackage.SINGLE_VARIABLE_DECLARATION__CATCH_CLAUSE && newCatchClause != null)) {
			...
			if (newCatchClause != null)
				msgs = ((InternalEObject) newCatchClause).eInverseAdd(this,
						JavaPackage.CATCH_CLAUSE__EXCEPTION, CatchClause.class,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JavaPackage.SINGLE_VARIABLE_DECLARATION__CATCH_CLAUSE,
	...
	public EnhancedForStatement getEnhancedForStatement() {
		if (eContainerFeatureID() != JavaPackage.SINGLE_VARIABLE_DECLARATION__ENHANCED_FOR_STATEMENT)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEnhancedForStatement(
			EnhancedForStatement newEnhancedForStatement, NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newEnhancedForStatement,
				JavaPackage.SINGLE_VARIABLE_DECLARATION__ENHANCED_FOR_STATEMENT,
				msgs);
		return msgs;
	}
	...
	public void setEnhancedForStatement(
		...
		if (newEnhancedForStatement != eInternalContainer()
				|| (eContainerFeatureID() != JavaPackage.SINGLE_VARIABLE_DECLARATION__ENHANCED_FOR_STATEMENT && newEnhancedForStatement != null)) {
			...
			if (newEnhancedForStatement != null)
				msgs = ((InternalEObject) newEnhancedForStatement).eInverseAdd(
						this, JavaPackage.ENHANCED_FOR_STATEMENT__PARAMETER,
						EnhancedForStatement.class, msgs);
			...
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					JavaPackage.SINGLE_VARIABLE_DECLARATION__ENHANCED_FOR_STATEMENT,
					newEnhancedForStatement, newEnhancedForStatement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case JavaPackage.SINGLE_VARIABLE_DECLARATION__METHOD_DECLARATION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetMethodDeclaration(
					(AbstractMethodDeclaration) otherEnd, msgs);
		...
		case JavaPackage.SINGLE_VARIABLE_DECLARATION__ENHANCED_FOR_STATEMENT:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetEnhancedForStatement(
					(EnhancedForStatement) otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
		...
		case JavaPackage.SINGLE_VARIABLE_DECLARATION__ENHANCED_FOR_STATEMENT:
			return eInternalContainer().eInverseRemove(this,
					JavaPackage.ENHANCED_FOR_STATEMENT__PARAMETER,
					EnhancedForStatement.class, msgs);
		}
