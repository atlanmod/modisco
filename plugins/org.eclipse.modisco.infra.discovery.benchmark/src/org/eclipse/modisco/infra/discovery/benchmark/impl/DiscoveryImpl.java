 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getDicoveryDate <em>Dicovery Date</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getAlgorithmVariant <em>Algorithm Variant</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getDiscovererId <em>Discoverer Id</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getDiscovererClassName <em>Discoverer Class Name</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getSaveTimeInSeconds <em>Save Time In Seconds</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getTotalExecutionTimeInSeconds <em>Total Execution Time In Seconds</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getMetaModelVariant <em>Meta Model Variant</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getMaxUsedMemoryInBytes <em>Max Used Memory In Bytes</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getNumberOfModelElements <em>Number Of Model Elements</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getXmiSizeInBytes <em>Xmi Size In Bytes</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.impl.DiscoveryImpl#getDiscoveryError <em>Discovery Error</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DiscoveryImpl extends EObjectImpl implements Discovery {
	...
	public void setDicoveryDate(Date newDicoveryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchmarkPackage.DISCOVERY__DICOVERY_DATE, oldDicoveryDate, dicoveryDate));
	}
	...
	public void setAlgorithmVariant(String newAlgorithmVariant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchmarkPackage.DISCOVERY__ALGORITHM_VARIANT, oldAlgorithmVariant, algorithmVariant));
	}
	...
	public void setSaveTimeInSeconds(double newSaveTimeInSeconds) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchmarkPackage.DISCOVERY__SAVE_TIME_IN_SECONDS, oldSaveTimeInSeconds, saveTimeInSeconds));
	}
	...
	public void setTotalExecutionTimeInSeconds(double newTotalExecutionTimeInSeconds) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchmarkPackage.DISCOVERY__TOTAL_EXECUTION_TIME_IN_SECONDS, oldTotalExecutionTimeInSeconds, totalExecutionTimeInSeconds));
	}
	...
	public void setMetaModelVariant(String newMetaModelVariant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchmarkPackage.DISCOVERY__META_MODEL_VARIANT, oldMetaModelVariant, metaModelVariant));
	}
	...
	public void setMaxUsedMemoryInBytes(long newMaxUsedMemoryInBytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchmarkPackage.DISCOVERY__MAX_USED_MEMORY_IN_BYTES, oldMaxUsedMemoryInBytes, maxUsedMemoryInBytes));
	}
	...
	public void setDiscoveryError(String newDiscoveryError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchmarkPackage.DISCOVERY__DISCOVERY_ERROR, oldDiscoveryError, discoveryError));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BenchmarkPackage.DISCOVERY__DICOVERY_DATE:
				return getDicoveryDate();
			case BenchmarkPackage.DISCOVERY__ALGORITHM_VARIANT:
			...
			case BenchmarkPackage.DISCOVERY__SAVE_TIME_IN_SECONDS:
				return getSaveTimeInSeconds();
			case BenchmarkPackage.DISCOVERY__TOTAL_EXECUTION_TIME_IN_SECONDS:
				return getTotalExecutionTimeInSeconds();
			case BenchmarkPackage.DISCOVERY__META_MODEL_VARIANT:
				return getMetaModelVariant();
			case BenchmarkPackage.DISCOVERY__MAX_USED_MEMORY_IN_BYTES:
			...
			case BenchmarkPackage.DISCOVERY__NAME:
				return getName();
			case BenchmarkPackage.DISCOVERY__DISCOVERY_ERROR:
