 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.omg.kdm.build.impl.ToolImpl#getBuildRelation <em>Build Relation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ToolImpl extends KDMEntityImpl implements Tool {
	/**
	...
	protected EClass eStaticClass() {
		return BuildPackage.Literals.TOOL;
	}
	...
	public EList<AbstractBuildRelationship> getBuildRelation() {
		if (buildRelation == null) {
			buildRelation = new EObjectContainmentEList<AbstractBuildRelationship>(AbstractBuildRelationship.class, this, BuildPackage.TOOL__BUILD_RELATION);
		}
