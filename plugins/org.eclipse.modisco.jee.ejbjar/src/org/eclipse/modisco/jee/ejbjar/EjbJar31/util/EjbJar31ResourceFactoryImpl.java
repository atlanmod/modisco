 ...
 * 
 * @see org.eclipse.modisco.jee.ejbjar.EjbJar31.util.EjbJar31ResourceImpl
 * @generated
 */
public class EjbJar31ResourceFactoryImpl extends ResourceFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public EjbJar31ResourceFactoryImpl() {
		super();
	}
	...
	public Resource createResource(final URI uri) {
		XMLResource result = new EjbJar31ResourceImpl(uri);
	...
	class MoDiscoURIHandler implements URIHandler {
		...
		private final URI jeeStandardURI = URI
				.createURI("http://java.sun.com/xml/ns/javaee/ejb-jar_3_1.xsd"); //$NON-NLS-1$

		private final URI modiscoSubstituteURI = URI
				.createURI("http://www.eclipse.org/MoDisco/Javaee/ejb-jar_3_1.xsd"); //$NON-NLS-1$
