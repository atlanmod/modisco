 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.EmptyTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EmptyTypeImpl extends EObjectImpl implements EmptyType {
	...
	protected EClass eStaticClass() {
		return EjbJar30Package.eINSTANCE.getEmptyType();
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.EMPTY_TYPE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EjbJar30Package.EMPTY_TYPE__ID:
				return getId();
		}
