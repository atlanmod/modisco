 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar31.impl.AroundInvokeTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar31.impl.AroundInvokeTypeImpl#getMethodName <em>Method Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AroundInvokeTypeImpl extends EObjectImpl implements AroundInvokeType {
	...
	protected EClass eStaticClass() {
		return EjbJar31Package.eINSTANCE.getAroundInvokeType();
	}
	...
	public NotificationChain basicSetClass(FullyQualifiedClassType newClass, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EjbJar31Package.AROUND_INVOKE_TYPE__CLASS, oldClass, newClass);
	...
	public void setClass(FullyQualifiedClassType newClass) {
		if (newClass != class_) {
			...
			if (class_ != null)
				msgs = ((InternalEObject)class_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EjbJar31Package.AROUND_INVOKE_TYPE__CLASS, null, msgs);
			if (newClass != null)
				msgs = ((InternalEObject)newClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EjbJar31Package.AROUND_INVOKE_TYPE__CLASS, null, msgs);
			msgs = basicSetClass(newClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar31Package.AROUND_INVOKE_TYPE__CLASS, newClass, newClass));
	}
	...
	public NotificationChain basicSetMethodName(JavaIdentifierType newMethodName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EjbJar31Package.AROUND_INVOKE_TYPE__METHOD_NAME, oldMethodName, newMethodName);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMethodName(JavaIdentifierType newMethodName) {
		if (newMethodName != methodName) {
			NotificationChain msgs = null;
			if (methodName != null)
				msgs = ((InternalEObject)methodName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EjbJar31Package.AROUND_INVOKE_TYPE__METHOD_NAME, null, msgs);
			if (newMethodName != null)
				msgs = ((InternalEObject)newMethodName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EjbJar31Package.AROUND_INVOKE_TYPE__METHOD_NAME, null, msgs);
			msgs = basicSetMethodName(newMethodName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar31Package.AROUND_INVOKE_TYPE__METHOD_NAME, newMethodName, newMethodName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EjbJar31Package.AROUND_INVOKE_TYPE__CLASS:
				return basicSetClass(null, msgs);
			case EjbJar31Package.AROUND_INVOKE_TYPE__METHOD_NAME:
