 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.RelationshipsTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.RelationshipsTypeImpl#getEjbRelation <em>Ejb Relation</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.RelationshipsTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationshipsTypeImpl extends EObjectImpl implements RelationshipsType {
	...
	protected EClass eStaticClass() {
		return EjbJar30Package.eINSTANCE.getRelationshipsType();
	}
	...
	public EList<DescriptionType> getDescription() {
		if (description == null) {
			description = new EObjectContainmentEList<DescriptionType>(DescriptionType.class, this, EjbJar30Package.RELATIONSHIPS_TYPE__DESCRIPTION);
		}
		return description;
	}
	...
	public EList<EjbRelationType> getEjbRelation() {
		if (ejbRelation == null) {
			ejbRelation = new EObjectContainmentEList<EjbRelationType>(EjbRelationType.class, this, EjbJar30Package.RELATIONSHIPS_TYPE__EJB_RELATION);
		}
		return ejbRelation;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.RELATIONSHIPS_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EjbJar30Package.RELATIONSHIPS_TYPE__DESCRIPTION:
				return ((InternalEList<?>)getDescription()).basicRemove(otherEnd, msgs);
			case EjbJar30Package.RELATIONSHIPS_TYPE__EJB_RELATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EjbJar30Package.RELATIONSHIPS_TYPE__ID:
				return getId();
		}
