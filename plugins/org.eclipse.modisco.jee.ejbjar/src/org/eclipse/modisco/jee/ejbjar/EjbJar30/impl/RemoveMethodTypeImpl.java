 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.RemoveMethodTypeImpl#getBeanMethod <em>Bean Method</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.RemoveMethodTypeImpl#getRetainIfException <em>Retain If Exception</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.RemoveMethodTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemoveMethodTypeImpl extends EObjectImpl implements RemoveMethodType {
	...
	protected EClass eStaticClass() {
		return EjbJar30Package.eINSTANCE.getRemoveMethodType();
	}
	...
	public NotificationChain basicSetBeanMethod(NamedMethodType newBeanMethod, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EjbJar30Package.REMOVE_METHOD_TYPE__BEAN_METHOD, oldBeanMethod, newBeanMethod);
	...
	public void setBeanMethod(NamedMethodType newBeanMethod) {
		if (newBeanMethod != beanMethod) {
			...
			if (beanMethod != null)
				msgs = ((InternalEObject)beanMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EjbJar30Package.REMOVE_METHOD_TYPE__BEAN_METHOD, null, msgs);
			if (newBeanMethod != null)
				msgs = ((InternalEObject)newBeanMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EjbJar30Package.REMOVE_METHOD_TYPE__BEAN_METHOD, null, msgs);
			msgs = basicSetBeanMethod(newBeanMethod, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.REMOVE_METHOD_TYPE__BEAN_METHOD, newBeanMethod, newBeanMethod));
	}
	...
	public NotificationChain basicSetRetainIfException(TrueFalseType newRetainIfException, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EjbJar30Package.REMOVE_METHOD_TYPE__RETAIN_IF_EXCEPTION, oldRetainIfException, newRetainIfException);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRetainIfException(TrueFalseType newRetainIfException) {
		if (newRetainIfException != retainIfException) {
			...
			if (retainIfException != null)
				msgs = ((InternalEObject)retainIfException).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EjbJar30Package.REMOVE_METHOD_TYPE__RETAIN_IF_EXCEPTION, null, msgs);
			if (newRetainIfException != null)
				msgs = ((InternalEObject)newRetainIfException).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EjbJar30Package.REMOVE_METHOD_TYPE__RETAIN_IF_EXCEPTION, null, msgs);
			msgs = basicSetRetainIfException(newRetainIfException, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.REMOVE_METHOD_TYPE__RETAIN_IF_EXCEPTION, newRetainIfException, newRetainIfException));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.REMOVE_METHOD_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EjbJar30Package.REMOVE_METHOD_TYPE__BEAN_METHOD:
				return basicSetBeanMethod(null, msgs);
			case EjbJar30Package.REMOVE_METHOD_TYPE__RETAIN_IF_EXCEPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EjbJar30Package.REMOVE_METHOD_TYPE__ID:
				return getId();
		}
