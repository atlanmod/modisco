...
public class AxeItemProvider
	 ...
	 * @generated
	 */
	public AxeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Axe"));
	}
	...
	public String getText(Object object) {
		String label = ((Axe)object).getLegend();
		return label == null || label.length() == 0 ?
			getString("_UI_Axe_type") :
			getString("_UI_Axe_type") + " " + label;
	}
