...
import org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.Resource;
 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getDiscovererId <em>Discoverer Id</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getDiscovererClassName <em>Discoverer Class Name</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getDiscoveryTimeAverageInSeconds <em>Discovery Time Average In Seconds</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getSaveTimeAverageInSeconds <em>Save Time Average In Seconds</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getExecutionTimeStandardDeviation <em>Execution Time Standard Deviation</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getSaveTimeStandardDeviation <em>Save Time Standard Deviation</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getNumberOfModelElements <em>Number Of Model Elements</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getXmiSizeInBytes <em>Xmi Size In Bytes</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getProject <em>Project</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getIterations <em>Iterations</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getDiscovererLaunchConfiguration <em>Discoverer Launch Configuration</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryImpl#getCopyOfDiscovererDescription <em>Copy Of Discoverer Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
