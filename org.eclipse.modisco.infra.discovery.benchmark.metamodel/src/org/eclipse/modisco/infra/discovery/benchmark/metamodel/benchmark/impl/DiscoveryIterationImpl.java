 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryIterationImpl#getDiscoveryDate <em>Discovery Date</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryIterationImpl#getDiscoveryTimeInSeconds <em>Discovery Time In Seconds</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryIterationImpl#getSaveTimeInSeconds <em>Save Time In Seconds</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryIterationImpl#getMaxUsedMemoryInBytes <em>Max Used Memory In Bytes</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryIterationImpl#getDiscoveryErrors <em>Discovery Errors</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryIterationImpl#getEvents <em>Events</em>}</li>
 *   <li>{@link org.eclipse.modisco.infra.discovery.benchmark.metamodel.benchmark.impl.DiscoveryIterationImpl#getMemoryMeasurements <em>Memory Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
