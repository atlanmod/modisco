...
public class EventTypeImpl extends EObjectImpl implements EventType {
	...
	protected EClass eStaticClass() {
		return BenchmarkPackage.Literals.EVENT_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchmarkPackage.EVENT_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BenchmarkPackage.EVENT_TYPE__NAME:
				return getName();
		}
