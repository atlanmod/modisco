...
public class MethodcallsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MethodcallsSwitch<Adapter> modelSwitch =
		new MethodcallsSwitch<Adapter>() {
			@Override
			public Adapter caseMethodCall(MethodCall object) {
				return createMethodCallAdapter();
			}
			@Override
			public Adapter caseCallsModel(CallsModel object) {
				return createCallsModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.modisco.usecase.modelfilter.methodcalls.methodcalls.MethodCall <em>Method Call</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.modisco.usecase.modelfilter.methodcalls.methodcalls.CallsModel <em>Calls Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.modisco.usecase.modelfilter.methodcalls.methodcalls.CallNode <em>Call Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
