...
public class IsWebInitParam implements IJavaModelQuery<ClassDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "WebInitParam"; //$NON-NLS-1$
	...
	public Boolean evaluate(final ClassDeclaration context,
		...
		return EvaluateAnnotation.evaluate(context,
				IsWebInitParam.ANNOTATION_NAME);
	}
