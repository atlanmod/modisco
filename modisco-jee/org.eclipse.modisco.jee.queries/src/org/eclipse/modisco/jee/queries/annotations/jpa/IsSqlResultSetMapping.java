...
public class IsSqlResultSetMapping implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "SqlResultSetMapping"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsSqlResultSetMapping.ANNOTATION_NAME);
	}
