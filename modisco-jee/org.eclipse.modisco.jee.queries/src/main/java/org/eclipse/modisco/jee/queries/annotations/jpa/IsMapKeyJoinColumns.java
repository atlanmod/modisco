...
public class IsMapKeyJoinColumns implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "MapKeyJoinColumns"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsMapKeyJoinColumns.ANNOTATION_NAME);
	}
