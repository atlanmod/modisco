...
public class IsMultipartConfig implements IJavaModelQuery<ClassDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "MultipartConfig"; //$NON-NLS-1$
	...
	public Boolean evaluate(final ClassDeclaration context,
		...
		return EvaluateAnnotation.evaluate(context,
				IsMultipartConfig.ANNOTATION_NAME);
	}
