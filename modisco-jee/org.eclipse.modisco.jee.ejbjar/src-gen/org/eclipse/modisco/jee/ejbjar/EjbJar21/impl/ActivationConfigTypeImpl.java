 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.ActivationConfigTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.ActivationConfigTypeImpl#getActivationConfigProperty <em>Activation Config Property</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.ActivationConfigTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivationConfigTypeImpl extends EObjectImpl implements ActivationConfigType {
	...
	protected EClass eStaticClass() {
		return EjbJar21Package.Literals.ACTIVATION_CONFIG_TYPE;
	}
	...
	public EList<DescriptionType> getDescription() {
		if (description == null) {
			description = new EObjectContainmentEList<DescriptionType>(DescriptionType.class, this, EjbJar21Package.ACTIVATION_CONFIG_TYPE__DESCRIPTION);
		}
		return description;
	}
	...
	public EList<ActivationConfigPropertyType> getActivationConfigProperty() {
		if (activationConfigProperty == null) {
			activationConfigProperty = new EObjectContainmentEList<ActivationConfigPropertyType>(ActivationConfigPropertyType.class, this, EjbJar21Package.ACTIVATION_CONFIG_TYPE__ACTIVATION_CONFIG_PROPERTY);
		}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar21Package.ACTIVATION_CONFIG_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EjbJar21Package.ACTIVATION_CONFIG_TYPE__DESCRIPTION:
				return ((InternalEList<?>)getDescription()).basicRemove(otherEnd, msgs);
			case EjbJar21Package.ACTIVATION_CONFIG_TYPE__ACTIVATION_CONFIG_PROPERTY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EjbJar21Package.ACTIVATION_CONFIG_TYPE__ID:
				return getId();
		}
