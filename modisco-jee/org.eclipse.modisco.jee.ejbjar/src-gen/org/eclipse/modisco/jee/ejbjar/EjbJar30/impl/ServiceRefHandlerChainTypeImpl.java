 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.ServiceRefHandlerChainTypeImpl#getServiceNamePattern <em>Service Name Pattern</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.ServiceRefHandlerChainTypeImpl#getPortNamePattern <em>Port Name Pattern</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.ServiceRefHandlerChainTypeImpl#getProtocolBindings <em>Protocol Bindings</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.ServiceRefHandlerChainTypeImpl#getHandler <em>Handler</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.ServiceRefHandlerChainTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceRefHandlerChainTypeImpl extends EObjectImpl implements ServiceRefHandlerChainType {
	...
	protected EClass eStaticClass() {
		return EjbJar30Package.eINSTANCE.getServiceRefHandlerChainType();
	}
	...
	public void setServiceNamePattern(String newServiceNamePattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__SERVICE_NAME_PATTERN, oldServiceNamePattern, serviceNamePattern));
	}
	...
	public void setPortNamePattern(String newPortNamePattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__PORT_NAME_PATTERN, oldPortNamePattern, portNamePattern));
	}
	...
	public void setProtocolBindings(List<String> newProtocolBindings) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__PROTOCOL_BINDINGS, oldProtocolBindings, protocolBindings));
	}
	...
	public EList<ServiceRefHandlerType> getHandler() {
		if (handler == null) {
			handler = new EObjectContainmentEList<ServiceRefHandlerType>(ServiceRefHandlerType.class, this, EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__HANDLER);
		}
		return handler;
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__HANDLER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__SERVICE_NAME_PATTERN:
				return getServiceNamePattern();
			case EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__PORT_NAME_PATTERN:
				return getPortNamePattern();
			case EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__PROTOCOL_BINDINGS:
				return getProtocolBindings();
			case EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__HANDLER:
				return getHandler();
			case EjbJar30Package.SERVICE_REF_HANDLER_CHAIN_TYPE__ID:
				return getId();
		}
