...
public class IContainerCellEditor extends DialogCellEditor {
	...
	protected Object openDialogBox(final Control cellEditorWindow) {
		...
		dialog.setTitle(Messages.IContainerCellEditor_0);
		dialog.setMessage(Messages.IContainerCellEditor_1);
		...
		dialog.addFilter(new ViewerFilter() {
			...
			public boolean select(final Viewer viewer, final Object parentElement,
				...
				// IContainer needed to display containers (projects)
