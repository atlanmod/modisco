 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.omg.gastm.impl.PointerTypeImpl#getSize <em>Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointerTypeImpl extends ConstructedTypeImpl implements PointerType {
	...
	protected EClass eStaticClass() {
		return GASTMPackage.eINSTANCE.getPointerType();
	}
	...
	public void setSize(Integer newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GASTMPackage.POINTER_TYPE__SIZE, oldSize, size));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GASTMPackage.POINTER_TYPE__SIZE:
				return getSize();
		}
