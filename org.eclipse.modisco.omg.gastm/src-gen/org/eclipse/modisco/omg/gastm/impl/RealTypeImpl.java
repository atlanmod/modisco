 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.omg.gastm.impl.RealTypeImpl#getPrecision <em>Precision</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RealTypeImpl extends NumberTypeImpl implements RealType {
	...
	public void setPrecision(Integer newPrecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GASTMPackage.REAL_TYPE__PRECISION, oldPrecision, precision));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GASTMPackage.REAL_TYPE__PRECISION:
				return getPrecision();
		}
