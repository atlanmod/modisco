...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Method Call</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.gmt.modisco.usecase.modelfilter.methodcalls.model.methodcalls.impl.MethodCallImpl#getOrder
 * <em>Order</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.usecase.modelfilter.methodcalls.model.methodcalls.impl.MethodCallImpl#getParent
 * <em>Parent</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.usecase.modelfilter.methodcalls.model.methodcalls.impl.MethodCallImpl#getCallee
 * <em>Callee</em>}</li>
 * <li>
 * {@link org.eclipse.gmt.modisco.usecase.modelfilter.methodcalls.model.methodcalls.impl.MethodCallImpl#getFilteredSubMethods
...
public class MethodCallImpl extends EObjectImpl implements MethodCall {
	/**
	 * The default value of the '{@link #getOrder() <em>Order</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getOrder()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOrder() <em>Order</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getOrder()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getCallee() <em>Callee</em>}' reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getCallee()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getFilteredSubMethods() <em>Filtered Sub Methods</em>}'
	...
	public void setOrder(int newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MethodcallsPackage.METHOD_CALL__ORDER, oldOrder, order));
	}
	...
	public CallNode getParent() {
		if (eContainerFeatureID() != MethodcallsPackage.METHOD_CALL__PARENT)
			return null;
	...
	public NotificationChain basicSetParent(CallNode newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newParent,
				MethodcallsPackage.METHOD_CALL__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(CallNode newParent) {
		if (newParent != eInternalContainer()
				|| (eContainerFeatureID() != MethodcallsPackage.METHOD_CALL__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject) newParent).eInverseAdd(this,
						MethodcallsPackage.CALL_NODE__METHOD_CALLS, CallNode.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MethodcallsPackage.METHOD_CALL__PARENT, newParent, newParent));
	}
			...
			if (callee != oldCallee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MethodcallsPackage.METHOD_CALL__CALLEE, oldCallee, callee));
			}
		}
		return callee;
	}
	...
	public EList<CallNode> getFilteredSubMethods() {
		if (filteredSubMethods == null) {
			filteredSubMethods = new EObjectResolvingEList<CallNode>(CallNode.class, this,
					MethodcallsPackage.METHOD_CALL__FILTERED_SUB_METHODS);
		}
