...
<asm version="1.0" name="0">
	...
	<operation name="112">
		...
		<linenumbertable>
			...
			<lne id="129" begin="12" end="13"/>
			<lne id="130" begin="12" end="14"/>
			<lne id="131" begin="12" end="15"/>
			<lne id="132" begin="16" end="16"/>
			<lne id="133" begin="12" end="17"/>
			<lne id="134" begin="7" end="19"/>
			<lne id="135" begin="34" end="47"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="2" name="136" begin="11" end="18"/>
			<lve slot="1" name="123" begin="6" end="49"/>
	...
	<operation name="137">
		...
		<localvariabletable>
			<lve slot="2" name="123" begin="3" end="3"/>
			<lve slot="0" name="26" begin="0" end="3"/>
			<lve slot="1" name="140" begin="0" end="3"/>
		</localvariabletable>
	</operation>
</asm>
