...
import org.eclipse.gmt.modisco.java.nousages.cdo.meta.JavaFactory;
...
public class JavaPackageImpl extends EPackageImpl implements JavaPackage {
	 ...
	 * @see org.eclipse.gmt.modisco.java.nousages.cdo.meta.JavaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link JavaPackage#eINSTANCE} when that
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier
					.setInstanceClassName("org.eclipse.gmt.modisco.java." + eClassifier.getName()); //$NON-NLS-1$
