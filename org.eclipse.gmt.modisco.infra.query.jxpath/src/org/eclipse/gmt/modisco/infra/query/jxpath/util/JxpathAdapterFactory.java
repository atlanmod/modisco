...
public class JxpathAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected JxpathSwitch<Adapter> modelSwitch =
		new JxpathSwitch<Adapter>() {
			@Override
			public Adapter caseJXPathModelQuery(JXPathModelQuery object) {
				return createJXPathModelQueryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.gmt.modisco.infra.query.jxpath.JXPathModelQuery <em>JX Path Model Query</em>}'.
	 * <!-- begin-user-doc -->
