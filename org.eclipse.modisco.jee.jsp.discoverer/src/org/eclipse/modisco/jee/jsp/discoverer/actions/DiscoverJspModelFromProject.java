...
public class DiscoverJspModelFromProject extends DefaultDiscoverer {
	 ...
	 * This discoverer does not create additional physical artifacts.
	 * 
	 * @param source
	 *            a IFile instance pointing Project
	 * @param target
	 *            should be null here.
	 */
	...
	public List<DiscoveryParameter> getDiscovererParameters() {
		if (DiscoverJspModelFromProject.parametersKeys == null) {
			DiscoverJspModelFromProject.parametersKeys = new ArrayList<DiscoveryParameter>();
			DiscoverJspModelFromProject.parametersKeys.add(DefaultDiscoverer.PARAMETER_SILENT_MODE);
			DiscoverJspModelFromProject.parametersKeys
					.add(DefaultDiscoverer.PARAMETER_TARGET_RESOURCE);
			DiscoverJspModelFromProject.parametersKeys
					.add(DefaultDiscoverer.PARAMETER_SERIALIZE_XMI);
		}
		return DiscoverJspModelFromProject.parametersKeys;
	}
