...
public class MoDiscoXMLSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MoDiscoXMLPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MoDiscoXMLPackage.ATTRIBUTE: {
			...
			case MoDiscoXMLPackage.ELEMENT: {
			...
			case MoDiscoXMLPackage.NAMESPACE: {
			...
			case MoDiscoXMLPackage.COMMENT: {
			...
			case MoDiscoXMLPackage.DOCUMENT_TYPE_DECLARATION: {
			...
			case MoDiscoXMLPackage.PROCESSING_INSTRUCTION: {
