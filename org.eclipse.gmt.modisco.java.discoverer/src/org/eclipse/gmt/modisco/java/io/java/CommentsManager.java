...
public final class CommentsManager {
	...
	public static void resolveCommentPositions(final JDTVisitor visitor) {
		...
		for (Comment comment : unLocatedComments) {
			...
			boolean locationFound = manager
					.alternateLocationSearch(comment, visitor, moDiscoCuNode);
	 ...
	 * @param visitor
	 */
	private boolean alternateLocationSearch(final Comment comment, final JDTVisitor visitor,
			final org.eclipse.gmt.modisco.java.CompilationUnit moDiscoCuNode) {
	 ...
	 */
	private void attachComment(final Comment comment,
	 ...
	 */
	private boolean mayOwnComment(final org.eclipse.jdt.core.dom.ASTNode element) {
