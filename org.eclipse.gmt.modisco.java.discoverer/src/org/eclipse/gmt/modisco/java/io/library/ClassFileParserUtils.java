...
public final class ClassFileParserUtils {
	...
	/**
	 * Resolves the Java model element and sorts the targeted <code>element</code> in the
	 * global <code>BindingManager</code>.
	 * @param element the declared Java entity.
	 * @param javaElement The Java model element corresponding to the declared Java entity.
	 * @param visitor the {@code ClassFileParser}.
	 */
	...
	/**
	 * Manage a reference on a type.
	 * If targeted type is already knowned, reference is resolved and the supplied
	 * {@code TypeAccess} is completed.
	 * If unkown, a pending reference is created and sorted in the global {@code BindingManager}.
	 * @param element the {@code TypeAccess} associated with this reference
	 * @param name The qualified dot based name of the referenced java entity.
	 * @param visitor the {@code ClassFileParser}
	 */
	public static void manageBindingRef(final TypeAccess element,
			final String name, final ClassFileParser visitor) {
		Binding id = JavaModelDelegateBindingFactory.getInstance().getBindingForName(name, visitor, false);
	 ...
	 * @param factory the EMF {@code factory}
	 * @param model the EMF {@code Model} object
	 * @param globalBindings the global {@code BindingManager}
	 */
	public static void initializePrimitiveTypes(final JavaFactory factory,
			final Model model, final BindingManager globalBindings) {
		...
		if (globalBindings.getTarget(org.eclipse.jdt.core.dom.PrimitiveType.INT.toString()) == null) {
			...
			globalBindings.addTarget(org.eclipse.jdt.core.dom.PrimitiveType.INT.toString(), primitiveType);
		}
		...
		if (globalBindings.getTarget(org.eclipse.jdt.core.dom.PrimitiveType.LONG.toString()) == null) {
			...
			model.getOrphanTypes().add(primitiveType);
			globalBindings.addTarget(org.eclipse.jdt.core.dom.PrimitiveType.LONG.toString(), primitiveType);
		}
		...
		if (globalBindings.getTarget(org.eclipse.jdt.core.dom.PrimitiveType.FLOAT.toString()) == null) {
			...
			model.getOrphanTypes().add(primitiveType);
			globalBindings.addTarget(org.eclipse.jdt.core.dom.PrimitiveType.FLOAT.toString(), primitiveType);
		}
		...
		if (globalBindings.getTarget(org.eclipse.jdt.core.dom.PrimitiveType.DOUBLE.toString()) == null) {
			...
			model.getOrphanTypes().add(primitiveType);
			globalBindings.addTarget(org.eclipse.jdt.core.dom.PrimitiveType.DOUBLE.toString(), primitiveType);
		}
		...
		if (globalBindings.getTarget(org.eclipse.jdt.core.dom.PrimitiveType.BOOLEAN.toString()) == null) {
			...
			model.getOrphanTypes().add(primitiveType);
			globalBindings.addTarget(org.eclipse.jdt.core.dom.PrimitiveType.BOOLEAN.toString(), primitiveType);
		}
		...
		if (globalBindings.getTarget(org.eclipse.jdt.core.dom.PrimitiveType.VOID.toString()) == null) {
			...
			model.getOrphanTypes().add(primitiveType);
			globalBindings.addTarget(org.eclipse.jdt.core.dom.PrimitiveType.VOID.toString(), primitiveType);
		}
		...
		if (globalBindings.getTarget(org.eclipse.jdt.core.dom.PrimitiveType.CHAR.toString()) == null) {
			...
			model.getOrphanTypes().add(primitiveType);
			globalBindings.addTarget(org.eclipse.jdt.core.dom.PrimitiveType.CHAR.toString(), primitiveType);
		}
		...
		if (globalBindings.getTarget(org.eclipse.jdt.core.dom.PrimitiveType.SHORT.toString()) == null) {
			...
			model.getOrphanTypes().add(primitiveType);
			globalBindings.addTarget(org.eclipse.jdt.core.dom.PrimitiveType.SHORT.toString(), primitiveType);
		}
		...
		if (globalBindings.getTarget(org.eclipse.jdt.core.dom.PrimitiveType.BYTE.toString()) == null) {
			...
			model.getOrphanTypes().add(primitiveType);
			globalBindings.addTarget(org.eclipse.jdt.core.dom.PrimitiveType.BYTE.toString(), primitiveType);
		}
	}
	 ...
	 * @return {@code true} if the supplied signature corresponds to the Object type, 
