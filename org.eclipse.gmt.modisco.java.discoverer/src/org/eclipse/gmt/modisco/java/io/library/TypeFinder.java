...
public class TypeFinder {
	 ...
	 * @param qualifiedName the dot based qualified name ({@code java.lang.String} for example)
	 * @return the {@code IType} corresponding to the qualified name, or {@code null}
	 * if type is unknow (not on the classpath of the Java Project)
