 ...
 * <ul>
 * <li>
 * {@link org.eclipse.gmt.modisco.java.nousages.impl.InitializerImpl#getBody
 * <em>Body</em>}</li>
 * </ul>
 * </p>
 * 
	...
	public NotificationChain basicSetBody(Block newBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, JavaPackage.INITIALIZER__BODY, oldBody,
					newBody);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject) body).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JavaPackage.INITIALIZER__BODY,
						null, msgs);
			if (newBody != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JavaPackage.INITIALIZER__BODY, newBody, newBody));
	}
