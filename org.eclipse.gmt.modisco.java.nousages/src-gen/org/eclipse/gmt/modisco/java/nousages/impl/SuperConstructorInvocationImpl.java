 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.nousages.impl.SuperConstructorInvocationImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.nousages.impl.SuperConstructorInvocationImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.nousages.impl.SuperConstructorInvocationImpl#getTypeArguments <em>Type Arguments</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.nousages.impl.SuperConstructorInvocationImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SuperConstructorInvocationImpl extends StatementImpl implements SuperConstructorInvocation {
	...
	public void setMethod(AbstractMethodDeclaration newMethod) {
		...
		method = newMethod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.SUPER_CONSTRUCTOR_INVOCATION__METHOD, oldMethod, method));
	}
