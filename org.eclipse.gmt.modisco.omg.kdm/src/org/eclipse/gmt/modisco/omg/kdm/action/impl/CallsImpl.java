 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.omg.kdm.action.impl.CallsImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.omg.kdm.action.impl.CallsImpl#getFrom <em>From</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CallsImpl extends AbstractActionRelationshipImpl implements Calls {
	...
	protected EClass eStaticClass() {
		return ActionPackage.Literals.CALLS;
	}
		...
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionPackage.CALLS__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(ControlElement newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.CALLS__TO, oldTo, to));
	}
	...
	public ActionElement getFrom() {
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionPackage.CALLS__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(ActionElement newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.CALLS__FROM, oldFrom, from));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionPackage.CALLS__TO:
				if (resolve) return getTo();
				return basicGetTo();
			case ActionPackage.CALLS__FROM:
