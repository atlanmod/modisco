...
public class CoreAdapterFactory extends AdapterFactoryImpl {
	...
	public CoreAdapterFactory() {
		if (CoreAdapterFactory.modelPackage == null) {
			CoreAdapterFactory.modelPackage = CorePackage.eINSTANCE;
		}
	}
	...
	public boolean isFactoryForType(final Object object) {
		if (object == CoreAdapterFactory.modelPackage) {
			return true;
		}
		if (object instanceof EObject) {
			return ((EObject)object).eClass().getEPackage() == CoreAdapterFactory.modelPackage;
		}
		return false;
	}
	...
	protected CoreSwitch<Adapter> modelSwitch =
		new CoreSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAggregatedRelationship(final AggregatedRelationship object) {
				return createAggregatedRelationshipAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.gmt.modisco.omg.kdm.core.AggregatedRelationship <em>Aggregated Relationship</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
