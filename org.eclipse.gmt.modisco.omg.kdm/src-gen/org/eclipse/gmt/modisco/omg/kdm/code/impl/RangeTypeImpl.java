 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.omg.kdm.code.impl.RangeTypeImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.omg.kdm.code.impl.RangeTypeImpl#getUpper <em>Upper</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RangeTypeImpl extends DerivedTypeImpl implements RangeType {
	...
	public void setLower(Integer newLower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodePackage.RANGE_TYPE__LOWER, oldLower, lower));
	}
	...
	public void setUpper(Integer newUpper) {
		...
		upper = newUpper;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodePackage.RANGE_TYPE__UPPER, oldUpper, upper));
	}
