...
public class CoreFactoryImpl extends EFactoryImpl implements CoreFactory {
	...
	public static CoreFactory init() {
		try {
			CoreFactory theCoreFactory = (CoreFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/MoDisco/kdm/core"); //$NON-NLS-1$ 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CorePackage.AGGREGATED_RELATIONSHIP: return createAggregatedRelationship();
			default:
	...
	public AggregatedRelationship createAggregatedRelationship() {
		AggregatedRelationshipImpl aggregatedRelationship = new AggregatedRelationshipImpl();
