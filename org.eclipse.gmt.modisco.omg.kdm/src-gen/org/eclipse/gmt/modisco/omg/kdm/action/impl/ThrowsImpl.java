 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.omg.kdm.action.impl.ThrowsImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.omg.kdm.action.impl.ThrowsImpl#getFrom <em>From</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ThrowsImpl extends AbstractActionRelationshipImpl implements Throws {
	/**
	...
	protected EClass eStaticClass() {
		return ActionPackage.Literals.THROWS;
	}
		...
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionPackage.THROWS__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(DataElement newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.THROWS__TO, oldTo, to));
	}
	...
	public ActionElement getFrom() {
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionPackage.THROWS__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(ActionElement newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.THROWS__FROM, oldFrom, from));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionPackage.THROWS__TO:
				if (resolve) return getTo();
				return basicGetTo();
			case ActionPackage.THROWS__FROM:
