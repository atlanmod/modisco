...
public class EjbJar31XMLProcessor extends XMLProcessor {
	...
	/**
	 * Register for "*" and "xml" file extensions the EjbJar31ResourceFactoryImpl factory.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	protected Map<String, Resource.Factory> getRegistrations() {
		if (registrations == null) {
			...
			registrations.put(XML_EXTENSION, new EjbJar31ResourceFactoryImpl());
			registrations.put(STAR_EXTENSION, new EjbJar31ResourceFactoryImpl());
		}
		return registrations;
	}

} //EjbJar31XMLProcessor
