 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar31.impl.DisplayNameTypeImpl#getLang <em>Lang</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DisplayNameTypeImpl extends StringImpl implements DisplayNameType {
	...
	protected EClass eStaticClass() {
		return EjbJar31Package.eINSTANCE.getDisplayNameType();
	}
	...
	public void setLang(String newLang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar31Package.DISPLAY_NAME_TYPE__LANG, oldLang, lang));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EjbJar31Package.DISPLAY_NAME_TYPE__LANG:
				return getLang();
		}
