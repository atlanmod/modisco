 ...
 * 
 * @see org.eclipse.modisco.jee.ejbjar.EjbJar30.util.EjbJar30ResourceImpl
 * @generated
 */
public class EjbJar30ResourceFactoryImpl extends ResourceFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public EjbJar30ResourceFactoryImpl() {
		super();
	}
	...
	public Resource createResource(final URI uri) {
		XMLResource result = new EjbJar30ResourceImpl(uri);
	...
	class MoDiscoURIHandler implements URIHandler {
		...
		private final URI jeeStandardURI = URI
				.createURI("http://java.sun.com/xml/ns/javaee/ejb-jar_3_0.xsd"); //$NON-NLS-1$

		private final URI modiscoSubstituteURI = URI
				.createURI("http://www.eclipse.org/MoDisco/Javaee/ejb-jar_3_0.xsd"); //$NON-NLS-1$
