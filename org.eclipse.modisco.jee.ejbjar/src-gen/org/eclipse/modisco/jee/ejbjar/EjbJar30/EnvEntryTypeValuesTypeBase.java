...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Env Entry Type Values Type Base</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.modisco.jee.ejbjar.EjbJar30.EjbJar30Package#getEnvEntryTypeValuesTypeBase()
 * @model extendedMetaData="name='env-entry-type-valuesType_._base'"
 * @generated
 */
public enum EnvEntryTypeValuesTypeBase implements Enumerator {
	 ...
	 * @ordered
	 */
	JAVA_LANG_BYTE(1, "javaLangByte", "java.lang.Byte"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	JAVA_LANG_CHARACTER(2, "javaLangCharacter", "java.lang.Character"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	JAVA_LANG_STRING(3, "javaLangString", "java.lang.String"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	JAVA_LANG_SHORT(4, "javaLangShort", "java.lang.Short"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	JAVA_LANG_INTEGER(5, "javaLangInteger", "java.lang.Integer"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	JAVA_LANG_DOUBLE(8, "javaLangDouble", "java.lang.Double"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @model name="javaLangBoolean" literal="java.lang.Boolean"
	 * @generated
	 * @ordered
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see #JAVA_LANG_BYTE
	 * @model name="javaLangByte" literal="java.lang.Byte"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="javaLangCharacter" literal="java.lang.Character"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="javaLangString" literal="java.lang.String"
	 * @generated
	 * @ordered
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see #JAVA_LANG_SHORT
	 * @model name="javaLangShort" literal="java.lang.Short"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="javaLangInteger" literal="java.lang.Integer"
	 * @generated
	 * @ordered
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see #JAVA_LANG_LONG
	 * @model name="javaLangLong" literal="java.lang.Long"
	 * @generated
	 * @ordered
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see #JAVA_LANG_FLOAT
	 * @model name="javaLangFloat" literal="java.lang.Float"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="javaLangDouble" literal="java.lang.Double"
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * An array of all the '<em><b>Env Entry Type Values Type Base</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final EnvEntryTypeValuesTypeBase[] VALUES_ARRAY =
		new EnvEntryTypeValuesTypeBase[] {
			JAVA_LANG_BOOLEAN,
			JAVA_LANG_BYTE,
			JAVA_LANG_CHARACTER,
			JAVA_LANG_STRING,
	...
	/**
	 * A public read-only list of all the '<em><b>Env Entry Type Values Type Base</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public static EnvEntryTypeValuesTypeBase get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EnvEntryTypeValuesTypeBase result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private EnvEntryTypeValuesTypeBase(int value, String name, String literal) {
		this.value = value;
		this.name = name;
