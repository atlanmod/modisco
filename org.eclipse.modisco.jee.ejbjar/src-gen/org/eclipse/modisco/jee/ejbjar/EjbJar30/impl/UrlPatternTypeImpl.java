 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar30.impl.UrlPatternTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UrlPatternTypeImpl extends EObjectImpl implements UrlPatternType {
	...
	protected EClass eStaticClass() {
		return EjbJar30Package.eINSTANCE.getUrlPatternType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar30Package.URL_PATTERN_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EjbJar30Package.URL_PATTERN_TYPE__VALUE:
				return getValue();
		}
