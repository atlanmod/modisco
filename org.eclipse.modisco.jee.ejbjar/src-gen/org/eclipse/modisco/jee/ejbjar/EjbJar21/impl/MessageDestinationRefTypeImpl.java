 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.MessageDestinationRefTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.MessageDestinationRefTypeImpl#getMessageDestinationRefName <em>Message Destination Ref Name</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.MessageDestinationRefTypeImpl#getMessageDestinationType <em>Message Destination Type</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.MessageDestinationRefTypeImpl#getMessageDestinationUsage <em>Message Destination Usage</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.MessageDestinationRefTypeImpl#getMessageDestinationLink <em>Message Destination Link</em>}</li>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.MessageDestinationRefTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageDestinationRefTypeImpl extends EObjectImpl implements MessageDestinationRefType {
	...
	protected EClass eStaticClass() {
		return EjbJar21Package.Literals.MESSAGE_DESTINATION_REF_TYPE;
	}
	...
	public EList<DescriptionType> getDescription() {
		if (description == null) {
			description = new EObjectContainmentEList<DescriptionType>(DescriptionType.class, this, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__DESCRIPTION);
		}
		return description;
	}
	...
	public NotificationChain basicSetMessageDestinationRefName(JndiNameType newMessageDestinationRefName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_REF_NAME, oldMessageDestinationRefName, newMessageDestinationRefName);
	...
	public void setMessageDestinationRefName(JndiNameType newMessageDestinationRefName) {
		if (newMessageDestinationRefName != messageDestinationRefName) {
			...
			if (messageDestinationRefName != null)
				msgs = ((InternalEObject)messageDestinationRefName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_REF_NAME, null, msgs);
			if (newMessageDestinationRefName != null)
				msgs = ((InternalEObject)newMessageDestinationRefName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_REF_NAME, null, msgs);
			msgs = basicSetMessageDestinationRefName(newMessageDestinationRefName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_REF_NAME, newMessageDestinationRefName, newMessageDestinationRefName));
	}
	...
	public NotificationChain basicSetMessageDestinationType(MessageDestinationTypeType newMessageDestinationType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_TYPE, oldMessageDestinationType, newMessageDestinationType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMessageDestinationType(MessageDestinationTypeType newMessageDestinationType) {
		if (newMessageDestinationType != messageDestinationType) {
			...
			if (messageDestinationType != null)
				msgs = ((InternalEObject)messageDestinationType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_TYPE, null, msgs);
			if (newMessageDestinationType != null)
				msgs = ((InternalEObject)newMessageDestinationType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_TYPE, null, msgs);
			msgs = basicSetMessageDestinationType(newMessageDestinationType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_TYPE, newMessageDestinationType, newMessageDestinationType));
	}
	...
	public NotificationChain basicSetMessageDestinationUsage(MessageDestinationUsageType newMessageDestinationUsage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_USAGE, oldMessageDestinationUsage, newMessageDestinationUsage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMessageDestinationUsage(MessageDestinationUsageType newMessageDestinationUsage) {
		if (newMessageDestinationUsage != messageDestinationUsage) {
			...
			if (messageDestinationUsage != null)
				msgs = ((InternalEObject)messageDestinationUsage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_USAGE, null, msgs);
			if (newMessageDestinationUsage != null)
				msgs = ((InternalEObject)newMessageDestinationUsage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_USAGE, null, msgs);
			msgs = basicSetMessageDestinationUsage(newMessageDestinationUsage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_USAGE, newMessageDestinationUsage, newMessageDestinationUsage));
	}
	...
	public NotificationChain basicSetMessageDestinationLink(MessageDestinationLinkType newMessageDestinationLink, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_LINK, oldMessageDestinationLink, newMessageDestinationLink);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMessageDestinationLink(MessageDestinationLinkType newMessageDestinationLink) {
		if (newMessageDestinationLink != messageDestinationLink) {
			...
			if (messageDestinationLink != null)
				msgs = ((InternalEObject)messageDestinationLink).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_LINK, null, msgs);
			if (newMessageDestinationLink != null)
				msgs = ((InternalEObject)newMessageDestinationLink).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_LINK, null, msgs);
			msgs = basicSetMessageDestinationLink(newMessageDestinationLink, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_LINK, newMessageDestinationLink, newMessageDestinationLink));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__DESCRIPTION:
				return ((InternalEList<?>)getDescription()).basicRemove(otherEnd, msgs);
			case EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_REF_NAME:
				return basicSetMessageDestinationRefName(null, msgs);
			case EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_TYPE:
				return basicSetMessageDestinationType(null, msgs);
			case EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_USAGE:
				return basicSetMessageDestinationUsage(null, msgs);
			case EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__MESSAGE_DESTINATION_LINK:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EjbJar21Package.MESSAGE_DESTINATION_REF_TYPE__ID:
				return getId();
		}
