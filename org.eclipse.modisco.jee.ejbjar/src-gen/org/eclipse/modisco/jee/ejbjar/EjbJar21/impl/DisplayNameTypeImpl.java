 ...
 * <ul>
 *   <li>{@link org.eclipse.modisco.jee.ejbjar.EjbJar21.impl.DisplayNameTypeImpl#getLang <em>Lang</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DisplayNameTypeImpl extends StringImpl implements DisplayNameType {
	...
	protected EClass eStaticClass() {
		return EjbJar21Package.Literals.DISPLAY_NAME_TYPE;
	}
	...
	public void setLang(String newLang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EjbJar21Package.DISPLAY_NAME_TYPE__LANG, oldLang, lang));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EjbJar21Package.DISPLAY_NAME_TYPE__LANG:
				return getLang();
		}
