...
public class IsPrimaryKeyJoinColumn implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "PrimaryKeyJoinColumn"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsPrimaryKeyJoinColumn.ANNOTATION_NAME);
	}
