...
public class IsExcludeSuperclassListeners implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "ExcludeSuperclassListeners"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsExcludeSuperclassListeners.ANNOTATION_NAME);
	}
