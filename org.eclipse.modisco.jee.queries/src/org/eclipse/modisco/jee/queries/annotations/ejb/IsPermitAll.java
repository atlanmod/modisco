...
public class IsPermitAll implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "PermitAll"; //$NON-NLS-1$
