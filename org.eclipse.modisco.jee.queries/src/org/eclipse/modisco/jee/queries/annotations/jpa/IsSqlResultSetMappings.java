...
public class IsSqlResultSetMappings implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "SqlResultSetMappings"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsSqlResultSetMappings.ANNOTATION_NAME);
	}
