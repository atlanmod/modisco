...
public class IsExcludeClassInterceptors implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "ExcludeClassInterceptors"; //$NON-NLS-1$
	...
	public Boolean evaluate(final BodyDeclaration context,
		...
		return EvaluateAnnotation.evaluate(context,
				IsExcludeClassInterceptors.ANNOTATION_NAME);
	}
