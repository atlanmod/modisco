...
public class IsMapKeyTemporal implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "MapKeyTemporal"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsMapKeyTemporal.ANNOTATION_NAME);
	}
