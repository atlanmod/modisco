...
public class IsMapKeyClass implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "MapKeyClass"; //$NON-NLS-1$
