...
public class IsDiscriminatorColumn implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "DiscriminatorColumn"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsDiscriminatorColumn.ANNOTATION_NAME);
	}
