...
public class IsNamedNativeQuery implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "NamedNativeQuery"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsNamedNativeQuery.ANNOTATION_NAME);
	}
