...
public class IsUniqueConstraint implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "UniqueConstraint"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsUniqueConstraint.ANNOTATION_NAME);
	}
