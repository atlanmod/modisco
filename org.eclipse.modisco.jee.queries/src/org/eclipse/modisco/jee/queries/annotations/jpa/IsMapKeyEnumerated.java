...
public class IsMapKeyEnumerated implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "MapKeyEnumerated"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsMapKeyEnumerated.ANNOTATION_NAME);
	}
