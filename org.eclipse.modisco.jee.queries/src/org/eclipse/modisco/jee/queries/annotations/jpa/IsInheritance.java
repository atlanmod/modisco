...
public class IsInheritance implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "Inheritance"; //$NON-NLS-1$
