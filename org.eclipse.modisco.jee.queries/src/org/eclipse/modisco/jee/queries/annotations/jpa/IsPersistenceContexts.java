...
public class IsPersistenceContexts implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "PersistenceContexts"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsPersistenceContexts.ANNOTATION_NAME);
	}
