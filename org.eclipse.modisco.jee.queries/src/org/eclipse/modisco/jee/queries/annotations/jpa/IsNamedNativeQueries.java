...
public class IsNamedNativeQueries implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "NamedNativeQueries"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsNamedNativeQueries.ANNOTATION_NAME);
	}
