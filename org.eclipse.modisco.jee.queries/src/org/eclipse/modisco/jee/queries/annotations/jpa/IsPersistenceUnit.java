...
public class IsPersistenceUnit implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "PersistenceUnit"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsPersistenceUnit.ANNOTATION_NAME);
	}
