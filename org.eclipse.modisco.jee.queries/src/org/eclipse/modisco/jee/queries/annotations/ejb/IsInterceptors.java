...
public class IsInterceptors implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "Interceptors"; //$NON-NLS-1$
	...
	public Boolean evaluate(final BodyDeclaration context,
		...
		return EvaluateAnnotation.evaluate(context,
				IsInterceptors.ANNOTATION_NAME);
	}
