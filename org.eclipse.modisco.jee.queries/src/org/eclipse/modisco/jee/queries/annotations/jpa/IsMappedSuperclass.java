...
public class IsMappedSuperclass implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "MappedSuperclass"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsMappedSuperclass.ANNOTATION_NAME);
	}
