...
public class IsAttributeOverrides implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "AttributeOverrides"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsAttributeOverrides.ANNOTATION_NAME);
	}
