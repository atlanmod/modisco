...
public class IsDeclareRoles implements IJavaModelQuery<ClassDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "DeclareRoles"; //$NON-NLS-1$
	...
	public Boolean evaluate(final ClassDeclaration context,
		...
		return EvaluateAnnotation.evaluate(context,
				IsDeclareRoles.ANNOTATION_NAME);
	}
