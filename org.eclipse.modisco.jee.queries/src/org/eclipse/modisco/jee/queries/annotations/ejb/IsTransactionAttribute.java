...
public class IsTransactionAttribute implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "TransactionAttribute"; //$NON-NLS-1$
	...
	public Boolean evaluate(final BodyDeclaration context,
		...
		return EvaluateAnnotation.evaluate(context,
				IsTransactionAttribute.ANNOTATION_NAME);
	}
