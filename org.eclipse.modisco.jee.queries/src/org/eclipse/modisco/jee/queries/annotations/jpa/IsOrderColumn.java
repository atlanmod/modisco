...
public class IsOrderColumn implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "OrderColumn"; //$NON-NLS-1$
