...
public class IsMapKeyJoinColumn implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "MapKeyJoinColumn"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsMapKeyJoinColumn.ANNOTATION_NAME);
	}
