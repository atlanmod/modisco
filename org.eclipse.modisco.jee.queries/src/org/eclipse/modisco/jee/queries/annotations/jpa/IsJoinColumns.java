...
public class IsJoinColumns implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "JoinColumns"; //$NON-NLS-1$
