...
public class IsPersistenceProperty implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "PersistenceProperty"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsPersistenceProperty.ANNOTATION_NAME);
	}
