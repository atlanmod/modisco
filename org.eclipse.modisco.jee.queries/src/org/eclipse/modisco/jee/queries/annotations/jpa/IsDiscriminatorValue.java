...
public class IsDiscriminatorValue implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "DiscriminatorValue"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsDiscriminatorValue.ANNOTATION_NAME);
	}
