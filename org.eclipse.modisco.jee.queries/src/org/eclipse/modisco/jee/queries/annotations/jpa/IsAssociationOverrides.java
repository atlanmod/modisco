...
public class IsAssociationOverrides implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "AssociationOverrides"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsAssociationOverrides.ANNOTATION_NAME);
	}
