...
public class IsSequenceGenerator implements IJavaModelQuery<BodyDeclaration, Boolean> {

	static final String ANNOTATION_NAME = "SequenceGenerator"; //$NON-NLS-1$
    ...
    throws ModelQueryExecutionException {
        ...
        return EvaluateAnnotation.evaluate(context,
				IsSequenceGenerator.ANNOTATION_NAME);
	}
